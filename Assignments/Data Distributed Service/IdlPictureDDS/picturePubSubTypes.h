...
#ifndef _PICTURE_PUBSUBTYPES_H_
#define _PICTURE_PUBSUBTYPES_H_
...
#error Generated picture is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type picture defined by the user in the IDL file.
 * @ingroup PICTURE
 */
class picturePubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef picture type;

    eProsima_user_DllExport picturePubSubType();

    eProsima_user_DllExport virtual ~picturePubSubType();
