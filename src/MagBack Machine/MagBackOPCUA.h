...
namespace festoLab
{
    ...
    class MagBackOpcuaAgent
    {
    public:
        MagBackOpcuaAgent(std::shared_ptr<spdlog::logger> logger) : Logger(logger)
        {
            try
            {
        ...
        bool readArrivingSensor() 
        {
            ...
            {
                Logger->error("Error in readArrivingSensor: {}", exc.what());
                return false;
            }
        };
        ...
        bool readArrivalSensor() 
        {
            ...
            {
                Logger->error("Error in readArrivalSensor: {}", exc.what());
                return false;
            }
        };
        ...
        {
            std::thread monitorCarrierArrivalThread(&MagBackOpcuaAgent::keepMonitoringCarrier, this, isStopp);
        ...
        {
            std::thread monitorMachineStateThread(&MagBackOpcuaAgent::keepMonitoringMachineState, this, machineState);
